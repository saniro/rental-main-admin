...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> New Host Applicants</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="tblapplicants">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Name</th>
      ...
      <div class = "modal fade" id = "modalApprove" role = "dialog">
        <div class = "modal-dialog">
          ...
          <div class="modal-content">
            <div class = "modal-header">
              <button type="button" class = "close" data-dismiss ="modal"> &times;</button>
                    <h4 class ="modal-title"> Approve New Host Application </h4>
                  </div>
                  <div class="modal-body">
                    <center>Note: Approved applications will appear in Current Hosts Sub Tab.</center>
                                <center><br><h4>Host Applicant</h4></center>
                                <form>    
                                    <center>
                                            <img src="" alt="Host Applicant Profile Picture">
                                    </center>
      ...
      <div class = "modal fade" id = "modalReject" role = "dialog">
        <div class = "modal-dialog">
          ...
          <div class="modal-content">
            <div class = "modal-header">
              <button type="button" class = "close" data-dismiss ="modal"> &times;</button>
                    <h4 class ="modal-title"> Reject Host Application </h4>
                  </div>
                  <div class="modal-body">
                    <center>Note: Rejected applications will appear in Rejected Hosts Sub Tab.</center>
                                <center><br><h4>Host Applicant</h4></center>
                                <form>    
                                    <center>
                                            <img src="" alt="Host Applicant Profile Picture">
